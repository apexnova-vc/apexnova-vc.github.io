...
RUN apt-get update && apt-get install -y curl gnupg software-properties-common git xsel wget xvfb openssh-client fonts-ipafont-gothic fonts-wqy-zenhei fonts-thai-tlwg fonts-kacst --no-install-recommends && \
