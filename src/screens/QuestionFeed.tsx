...
import {List, ListItemText, IconButton, Paper, ListItemButton} from '@mui/material';
...
const QuestionFeed: React.FC = () => {
    ...
    const [ deleteQuestion ] = useMutation<DeleteQuestion>(DELETE_QUESTION_MUTATION, {
            ...
            <List>
                {data?.questions?.map((question) => {
                    ...
                    >
                        ...
                        />
                        <IconButton edge="end" aria-label="delete" onClick={(event) => handleDelete(event, question.id)}>
                            <DeleteIcon />
                        </IconButton>
                    </ListItemButton>
                })}
